  ...
  return (
    <section id="skills" className="w-full h-full flex-shrink-0 snap-start snap-always p-2 md:p-4 lg:p-8 flex items-center justify-center">
      <div className="w-full max-w-6xl mx-auto h-full hacker-card p-4 md:p-8 lg:p-12 flex flex-col justify-center relative z-10 overflow-hidden">
        ...
        <h3 className="text-3xl md:text-5xl font-terminal text-gray-900 dark:text-gray-200">Technical Specs.</h3>
      </div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-1 lg:gap-2 flex-grow items-start content-start">
              {cat.skills.map((skill) => (
                <span 
                  key={skill}
                  className="px-2 py-1 lg:px-3 lg:py-1.5 rounded-md bg-gray-200 dark:bg-[#111] border border-gray-200 dark:border-gray-800 text-xs lg:text-sm text-gray-800 dark:text-gray-300 font-mono group-hover:border-terminal-green/30 transition-colors inline-block"
                >
                  {skill}
                </span>
              ))}
